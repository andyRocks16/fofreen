...
DROP TABLE IF EXISTS `air_purifiers`;
...
LOCK TABLES `air_purifiers` WRITE;
/*!40000 ALTER TABLE `air_purifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `air_purifiers` ENABLE KEYS */;
UNLOCK TABLES;
